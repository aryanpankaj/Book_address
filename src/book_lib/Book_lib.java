...
import java.awt.event.ActionEvent;
 ...
 public class Book_lib extends JFrame
 {
...
insertButton.setText( "Insert New Entry" );
 ...
 {
 personQuery.close(); // close database connection
...
maxTextField.setText( "" + numberOfEntries );
 ...
 try
 {
results = personQuery.getAllPeople();
 numberOfEntries = results.size();
 ...
 {
int result = personQuery.addPerson( firstNameTextField.getText(),
